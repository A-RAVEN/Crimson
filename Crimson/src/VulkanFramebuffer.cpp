...
namespace Crimson
{
	...
	void VulkanFramebuffer::ImageBarriers(VkCommandBuffer cmd_buffer, uint32_t cmd_queue_family)
	{
		...
		//	vkCmdPipelineBarrier(cmd_buffer, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT, VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT | VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT, 0, 0, nullptr, 0, nullptr, m_ImageMemoryBarriers.size(),
